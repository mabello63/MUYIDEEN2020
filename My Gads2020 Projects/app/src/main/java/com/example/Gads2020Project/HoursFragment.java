...
public class HoursFragment extends Fragment {
    ...
    private ArrayList<HoursData> hoursArray = new ArrayList<>(  );
    private TextView tvError;
    private static final String BASE_API_URL = "https://gadsapi.herokuapp.com/api/";
    private static final String LEARNING_HOURS = "hours";

   private class HoursQueryTask  extends AsyncTask<URL, Void, String>{
     ...
     //       mLoadingProgress.setVisibility(View.INVISIBLE);
            if (result == null) {
                rvHours.setVisibility(View.INVISIBLE);
                tvError.setVisibility(View.VISIBLE);
            } else {
                rvHours.setVisibility(View.VISIBLE);
//                tvError.setVisibility(View.INVISIBLE);
            }
            hoursArray = GadsApiUtil.getHoursFromJason( result );
            HourAdapter adapter = new HourAdapter(hoursArray);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String query_parameter = LEARNING_HOURS;
 ...
 //       mLoadingProgress = view.findViewById( R.id.pb_LoadingProgress );
        HoursQueryTask hourTask = new HoursQueryTask();
        hourTask.execute( queryUrl );
